...
TARGETS: list[tuple[str, str, str, dict[str, Any] | None]] = [
    ...
    ("relay_sqb_stats", LOCAL, "/api/sre/stats", None),
    ("relay_sqb_latest", LOCAL, "/api/sre/latest", None),
    ("relay_sqb_events", LOCAL, "/api/sre/events", {"limit": 5}),
    ...
    # --- SQB endpoints (gateway /api/sre/*) ---
    ("sqb_info", REMOTE, "/api/sre/info", None),
    ("sqb_live", REMOTE, "/api/sre/live", None),
    ("sqb_player_uid", REMOTE, f"/api/sre/player/{UID}", None),
    ("sqb_player_uid_games", REMOTE, f"/api/sre/player/{UID}/games", {"limit": 5}),
    ("sqb_player_uid_history", REMOTE, f"/api/sre/player/{UID}/history", None),
    ("sqb_search_nickname", REMOTE, f"/api/sre/search/{NICK}", None),
    ("sqb_match_sessionid", REMOTE, f"/api/sre/match/{SID}", None),
    ("sqb_match_sessionid_scoreboard", REMOTE, f"/api/sre/match/{SID}/scoreboard", None),
    ("sqb_games_search", REMOTE, "/api/sre/games/search", {"player": UID, "limit": 3}),
    ("sqb_maps", REMOTE, "/api/sre/maps", None),
    ("sqb_seasons", REMOTE, "/api/sre/seasons", None),
    ("sqb_squadrons_resolve", REMOTE, "/api/sre/squadrons/resolve", {"short": SQUAD}),
    ("sqb_squadrons_name", REMOTE, f"/api/sre/squadrons/{SQUAD}", None),
    ("sqb_squadrons_name_comps", REMOTE, f"/api/sre/squadrons/{SQUAD}/comps", {"limit": 5}),
    ("sqb_leaderboard_players", REMOTE, "/api/sre/leaderboard/players", {"limit": 3}),
    ("sqb_leaderboard_squadrons", REMOTE, "/api/sre/leaderboard/squadrons", {"limit": 3}),
    ("sqb_leaderboard_vehicles", REMOTE, "/api/sre/leaderboard/vehicles", {"limit": 3}),
    ("sqb_leaderboard_stats", REMOTE, "/api/sre/leaderboard/stats", None),
